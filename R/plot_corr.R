...
#' @param Levels The aggregation levels to take the two groups of indicators from.
...
#'
#' @export
iplot_corr <- function(coin, dset, iCodes = NULL, Levels = 1, cortype = "pearson",
                       withparent = FALSE, grouplev = NULL, showvals = TRUE, flagcolours = FALSE,
                       flagthresh = NULL, pval = 0.05, insig_colour = "#F0F0F0",
                       text_colour = NULL, discrete_colours = NULL, order_as = NULL, use_directions = FALSE){

  # here only boxes are left out for the moment
  plt <- COINr::plot_corr(
    coin = coin,
    dset = dset,
    iCodes = iCodes,
    ...
    flagthresh = flagthresh,
    pval = pval,
    insig_colour = insig_colour,
